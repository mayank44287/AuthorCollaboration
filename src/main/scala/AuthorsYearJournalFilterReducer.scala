//package mayankraj.hw2.AuthorsYearJournalFilterReducer
package reducers
import java.lang
...
class AuthorsYearJournalFilterReducer extends Reducer[Text, IntWritable, Text, IntWritable] with LazyLogging {
